...
<div class="container-fluid bg-dark mb-30" style="padding: 1%;">
    <div class="row px-xl-5">
        <div class="col-lg-3 col-6" style="flex: 0 0 auto;">
            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                                ...
                                @case(1)
                                    <div class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                            ...
                                            <a href="/Municipio" class="dropdown-item">Administrar Departamentos</a>
                                            <a href="/Departamento" class="dropdown-item">Administrar Municipios</a>
                                        </div>
                                    </div>
                                    @break
                                @case(2)
                                    <div class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                            <a href="#" class="dropdown-item">Opción de Cliente 1</a>
                                            <a href="#" class="dropdown-item">Opción de Cliente 2</a>
                                        </div>
                                    </div>
                                    @break
                            @endswitch
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        <a href="" class="btn px-0 ml-3 d-none d-lg-block">
                    ...
                    <div class="d-inline-flex align-items-center ml-2">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="/login"><button class="dropdown-item" type="button">Iniciar Sesión</button></a>
